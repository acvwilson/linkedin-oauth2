...
describe LinkedIn::Api do
  before do
    ...
    # client.stub(:client).and_return(oauth_client)
    client.authorize_from_access('atoken')
  end

  let(:client){LinkedIn::Client.new('token', 'secret')}
  let(:oauth_client){OAuth2::Client.new('token', 'secret', {site: 'https://api.linkedin.com'})}

  it "should be able to view the account profile" do
    stub_request(:get, "https://api.linkedin.com/v1/people/~?oauth2_access_token=atoken").to_return(body: "")
    client.profile.should be_an_instance_of(LinkedIn::Mash)
  end

  it "should be able to view public profiles" do
    stub_request(:get, "https://api.linkedin.com/v1/people/id=123?oauth2_access_token=atoken").to_return(body: "")
    client.profile(id: 123).should be_an_instance_of(LinkedIn::Mash)
  end

  it "should be able to view connections" do
    stub_request(:get, "https://api.linkedin.com/v1/people/~/connections?oauth2_access_token=atoken").to_return(body: "")
  ...
  it "should be able to search with an option" do
    stub_request(:get, "https://api.linkedin.com/v1/people-search?first-name=Javan&oauth2_access_token=atoken").to_return(body: "")
  ...
  it "should be able to search with an option and fetch specific fields" do
    stub_request(:get, "https://api.linkedin.com/v1/people-search:(num-results,total)?first-name=Javan&oauth2_access_token=atoken").to_return(
        body: "")
  ...
  it "should be able to share a new status" do
    stub_request(:post, "https://api.linkedin.com/v1/people/~/shares?oauth2_access_token=atoken").to_return(body: "", status: 201)
  ...
  it "should be able to comment on network update" do
    stub_request(:post, "https://api.linkedin.com/v1/people/~/network/updates/key=SOMEKEY/update-comments?oauth2_access_token=atoken").to_return(body: "", status: 201)
  ...
  it "should be able to send a message" do
    stub_request(:post, "https://api.linkedin.com/v1/people/~/mailbox?oauth2_access_token=atoken").to_return(body: "", status: 201)
  ...
  it "should be able to like a network update" do
    stub_request(:put, "https://api.linkedin.com/v1/people/~/network/updates/key=SOMEKEY/is-liked?oauth2_access_token=atoken").
      with(body: '<is-liked>true</is-liked>').to_return(body: "", status: 201)
  ...
  it "should be able to unlike a network update" do
    stub_request(:put, "https://api.linkedin.com/v1/people/~/network/updates/key=SOMEKEY/is-liked?oauth2_access_token=atoken").
      with(body: "<is-liked>false</is-liked>").to_return(body: "", status: 201)
  ...
  context "Company API" do
    ...
    it "should be able to view a company profile" do
      stub_request(:get, "https://api.linkedin.com/v1/companies/id=1586?oauth2_access_token=atoken").to_return(body: "")
      client.company(id: 1586).should be_an_instance_of(LinkedIn::Mash)
    end

    it "should be able to view a company by universal name" do
      stub_request(:get, "https://api.linkedin.com/v1/companies/universal-name=acme?oauth2_access_token=atoken").to_return(body: "")
      client.company(name: 'acme').should be_an_instance_of(LinkedIn::Mash)
    end

    it "should be able to view a company by e-mail domain" do
      stub_request(:get, "https://api.linkedin.com/v1/companies?email-domain=acme.com&oauth2_access_token=atoken").to_return(body: "")
  ...
  context "Job API" do
    ...
    it "should be able to view a job listing" do
      stub_request(:get, "https://api.linkedin.com/v1/jobs/id=1586?oauth2_access_token=atoken").to_return(body: "")
      client.job(id: 1586).should be_an_instance_of(LinkedIn::Mash)
    end

    it "should be able to view its job bookmarks" do
      stub_request(:get, "https://api.linkedin.com/v1/people/~/job-bookmarks?oauth2_access_token=atoken").to_return(body: "")
      client.job_bookmarks.should be_an_instance_of(LinkedIn::Mash)
    end

    it "should be able to view its job suggestion" do
      stub_request(:get, "https://api.linkedin.com/v1/people/~/suggestions/job-suggestions?oauth2_access_token=atoken").to_return(body: "")
      client.job_suggestions.should be_an_instance_of(LinkedIn::Mash)
    end

    it "should be able to add a bookmark" do
      stub_request(:post, "https://api.linkedin.com/v1/people/~/job-bookmarks?oauth2_access_token=atoken").to_return(body: "", status: 201)
  ...
  context "Group API" do
    ...
    it "should be able to list group memberships for a profile" do
      stub_request(:get, "https://api.linkedin.com/v1/people/~/group-memberships?oauth2_access_token=atoken").to_return(body: "")
      client.group_memberships.should be_an_instance_of(LinkedIn::Mash)
    end

    it "should be able to join a group" do
      stub_request(:put, "https://api.linkedin.com/v1/people/~/group-memberships/123?oauth2_access_token=atoken").to_return(body: "", status: 201)
  ...
  context "Errors" do
    it "should raise AccessDeniedError when LinkedIn returns 403 status code" do
      stub_request(:get, "https://api.linkedin.com/v1/people-search?first-name=Javan&oauth2_access_token=atoken").to_return(body: '', status: 403)
